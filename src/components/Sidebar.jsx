import {
  LayoutDashboard, Vote, CheckSquare, HardDrive,
...
const bottomNavItems = [
  ...
  { id: 'proposte',   label: 'Proposte',   icon: Vote },
];
    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-100">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center shadow-lg shadow-violet-200 shrink-0">
